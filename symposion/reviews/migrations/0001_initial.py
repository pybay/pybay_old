    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('commenter', models.ForeignKey(on_delete=models.CASCADE, verbose_name='Commenter', to=settings.AUTH_USER_MODEL)),
                ('proposal', models.ForeignKey(on_delete=models.CASCADE, to='symposion_proposals.ProposalBase', verbose_name='Proposal', related_name='comments')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('proposal', models.ForeignKey(on_delete=models.CASCADE, to='symposion_proposals.ProposalBase', verbose_name='Proposal', related_name='votes')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('submitted_at', models.DateTimeField(editable=False, verbose_name='Submitted at', default=datetime.datetime.now)),
                ('proposal', models.ForeignKey(on_delete=models.CASCADE, to='symposion_proposals.ProposalBase', verbose_name='Proposal', related_name='messages')),
                ('user', models.ForeignKey(on_delete=models.CASCADE, verbose_name='User', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject', models.CharField(verbose_name='Subject', max_length=100)),
                ('body', models.TextField(verbose_name='Body')),
                ('proposal', models.ForeignKey(on_delete=models.CASCADE, to='symposion_proposals.ProposalBase', verbose_name='Proposal', related_name='notifications')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('submitted_at', models.DateTimeField(editable=False, verbose_name='Submitted at', default=datetime.datetime.now)),
                ('proposal', models.ForeignKey(on_delete=models.CASCADE, to='symposion_proposals.ProposalBase', verbose_name='Proposal', related_name='reviews')),
                ('user', models.ForeignKey(on_delete=models.CASCADE, verbose_name='User', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('proposal', models.ForeignKey(on_delete=models.CASCADE, verbose_name='Proposal', to='symposion_proposals.ProposalBase')),
                ('user', models.ForeignKey(on_delete=models.CASCADE, verbose_name='User', to=settings.AUTH_USER_MODEL)),
            ],
        ),
