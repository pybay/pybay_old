    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('section', models.ForeignKey(on_delete=models.CASCADE, to='symposion_conference.Section', verbose_name='Section', related_name='proposal_kinds')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('proposal', models.ForeignKey(on_delete=models.CASCADE, to='symposion_proposals.ProposalBase', verbose_name='Proposal', related_name='supporting_documents')),
                ('uploaded_by', models.ForeignKey(on_delete=models.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Uploaded by')),
            ],
        ),
        migrations.AddField(
            model_name='proposalbase',
            name='kind',
            field=models.ForeignKey(on_delete=models.CASCADE, to='symposion_proposals.ProposalKind', verbose_name='Kind'),
        ),
        migrations.AddField(
            model_name='proposalbase',
            name='speaker',
            field=models.ForeignKey(on_delete=models.CASCADE, to='symposion_speakers.Speaker', verbose_name='Speaker', related_name='proposals'),
        ),
        migrations.AddField(
            model_name='additionalspeaker',
            name='proposalbase',
            field=models.ForeignKey(on_delete=models.CASCADE, to='symposion_proposals.ProposalBase', verbose_name='Proposalbase'),
        ),
        migrations.AddField(
            model_name='additionalspeaker',
            name='speaker',
            field=models.ForeignKey(on_delete=models.CASCADE, to='symposion_speakers.Speaker', verbose_name='Speaker'),
        ),
